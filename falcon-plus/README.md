...
[![GoDoc](https://godoc.org/falcon-plus?status.svg)](https://godoc.org/falcon-plus)
...
[![Go Report Card](https://goreportcard.com/badge/falcon-plus)](https://goreportcard.com/report/falcon-plus)
...
Please refer to ./docker/[README.md](https://falcon-plus/blob/master/docker/README.md).
...
```
cd $GOPATH/src/falcon-plus/scripts/mysql/db_schema/
...
Any issue or question is welcome, Please feel free to open [github issues](https://falcon-plus/issues) :)
